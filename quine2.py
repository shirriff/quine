...
c="l=260;d.rectangle((l,11,988,90),fill='black');d.text((l,10),'a=%r'%a);d.text((l,20),'b=%r'%b);d.text((l,30),'c=%r'%c);"
...
l=260;d.rectangle((l,11,988,90),fill='black');d.text((l,10),'a=%r'%a);d.text((l,20),'b=%r'%b);d.text((l,30),'c=%r'%c);
